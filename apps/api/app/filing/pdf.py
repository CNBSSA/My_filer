...
def render_pack_pdf(pack: dict[str, Any]) -> bytes:
    ...
    story.append(
        Paragraph(
            "This pack was generated by Mai Filer for the taxpayer's records and for "
            "submission to the Nigeria Revenue Service (NRS). It does not guarantee "
            "acceptance by the NRS.",
            META,
        )
    )
